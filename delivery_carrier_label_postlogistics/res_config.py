    ...
    _columns = {
        ...
        'proclima_logo': fields.related(
                ...
                help="The “pro clima” logo indicates an item for which the "
                     "surcharge for carbon-neutral shipping has been paid and "
                     "a contract to that effect has been signed. For Letters "
                     "with barcode (BMB) domestic, the ProClima logo is "
